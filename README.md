...
- Change directory to decode-morse-message
- Type ruby main.rb
...
Feel free to check the [issues page](https://github.com/benshidanny11/decode-morse-message/issues).
